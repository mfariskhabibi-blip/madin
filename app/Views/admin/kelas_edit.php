...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="content-area">
            ...
            <!-- FORM -->
            <form action="<?= base_url('admin/kelas/update/' . $kelas['id']) ?>" method="POST" class="form-card">
                <?= csrf_field() ?>
                    ...
                    <div class="grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="nama_kelas" class="form-control" 
                                   ...
                                   placeholder="Contoh: Kelas Tahfidz 1A, Kelas Tilawah 2B, dll."
                                   required>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="3" 
                                      placeholder="Deskripsikan kelas ini, misal: fokus program, target hafalan, dll."><?= htmlspecialchars($kelas['deskripsi'] ?? '') ?></textarea>
                            <div class="helper-text">Deskripsi singkat tentang kelas (opsional).</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <?php if(!empty($ustadzList)): ?>
                        <div class="ustadz-grid">
                            <?php foreach($ustadzList as $u): ?>
                                <?php $isSelected = in_array($u['id'], $currentTeacherIds); ?>
                    ...
                    <?php else: ?>
                        <div class="empty-ustadz">
                            ...
                            <p>Belum ada data ustadz yang tersedia.</p>
                            <small>Silakan tambah data ustadz terlebih dahulu di menu Data Ustadz.</small>
                        </div>
                    <?php endif; ?>
                </div>
