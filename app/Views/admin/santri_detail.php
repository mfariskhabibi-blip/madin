...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .profile-meta { display: flex; gap: 15px; align-items: center; }
        ...
        <div class="dashboard-content">
            <div class="top-nav">
                ...
                <div class="action-btns">
                    <button class="btn-action btn-edit" title="Edit Data"><i class="fas fa-edit"></i> Edit Data</button>
                    <button class="btn-action btn-delete" title="Hapus Data"><i class="fas fa-trash"></i> Hapus</button>
                </div>
            </div>
                    ...
                    <div class="premium-card">
                        ...
                        <div class="biodata-list">
                            ...
                            <div class="biodata-item">
                                ...
                                <p class="biodata-value"><?= date('d F Y', strtotime($santri['tanggal_lahir'])) ?></p>
                            </div>
                            <div class="biodata-item">
                            ...
                            <div class="biodata-item">
                                ...
                                <p class="biodata-value"><?= htmlspecialchars($santri['nama_ortu'] ?? 'Belum Ditautkan') ?></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="biodata-list">
                            <?php if ($parent): ?>
                                ...
                                <div class="biodata-item">
                                    ...
                                    <p class="biodata-value"><?= htmlspecialchars($parent['alamat'] ?? '-') ?></p>
                                </div>
                            <?php else: ?>
                                <div class="empty-state" style="padding: 20px;">
                                    <i class="fas fa-user-slash" style="font-size: 1.5rem;"></i>
                                    <p style="font-size: 0.85rem;">Data profil orang tua belum lengkap atau belum ditautkan.</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="col-right">
                    <div class="premium-card">
                        <div class="premium-card-header">
                            ...
                            <span class="badge-info" style="color: var(--primary);"><?= count($riwayat) ?> Setoran</span>
                        </div>
                                ...
                                <?php foreach ($riwayat as $r): ?>
                                    <div class="history-item">
                                        ...
                                        <div class="history-content">
                                            ...
                                            <h4 class="history-title"><?= htmlspecialchars($r['surah']) ?> (Ayat <?= $r['ayat_awal'] ?>-<?= $r['ayat_akhir'] ?>)</h4>
