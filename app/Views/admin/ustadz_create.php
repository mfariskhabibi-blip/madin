...
<head>
    ...
    <title>Tambah Profil Ustadz - PTQ Pencongan</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* PAGE HEADER CARD */
        .page-header-card {
            background: linear-gradient(135deg, var(--secondary) 0%, #1e8555 100%);
        ...
        .btn-primary { background: linear-gradient(135deg, var(--secondary) 0%, #1e8555 100%); color: #fff; box-shadow: 0 4px 12px rgba(38,162,105,0.3); }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 16px rgba(38,162,105,0.4); }
        ...
        <div class="dashboard-content">
            ...
            <div class="page-header-card">
                ...
                <div class="header-text">
                    <h1>Lengkapi Profil Ustadz</h1>
                    <p>Lengkapi data pengajar baru di sistem PTQ Pencongan</p>
                </div>
            </div>
            ...
            <form action="<?= base_url('admin/ustadz/store') ?>" method="POST">
                ...
                <div class="form-card">
                    <div class="form-card-header">
                        ...
                        <div>
                            ...
                            <p>Hubungkan profil dengan akun login yang sudah ada</p>
                        </div>
                    </div>
                    <div class="form-card-body">
                        <div class="form-grid">
                            <div class="form-group full-width">
                                <label class="form-label"><i class="fas fa-user-circle"></i> Pilih Akun User <span class="required">*</span></label>
                                <select name="id_user" class="form-control" required>
                                    <option value="">-- Pilih Akun Ustadz --</option>
                                    <?php foreach($userUstadz as $uu): ?>
                                        <?php 
                                            $selectedId = old('id_user', request()->getGet('id_user'));
                                        ?>
                                        <option value="<?= $uu['id'] ?>" <?= $selectedId == $uu['id'] ? 'selected' : '' ?>>
                                            <?= htmlspecialchars($uu['nama_lengkap']) ?> (@<?= htmlspecialchars($uu['username']) ?>)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin" class="form-control" required>
                                    <option value="L" <?= old('jenis_kelamin') == 'L' ? 'selected' : '' ?>>Laki-laki (Ustadz)</option>
                                    <option value="P" <?= old('jenis_kelamin') == 'P' ? 'selected' : '' ?>>Perempuan (Ustadzah)</option>
                                </select>
                            </div>
                            <div class="form-group">
                ...
                <div class="form-actions" style="background:transparent; padding:0; margin-bottom: 30px;">
                    <button type="submit" class="btn btn-primary" style="width:100%; justify-content:center; padding:16px;">
                        <i class="fas fa-save"></i> Simpan Profil Ustadz
                    </button>
                </div>
            </form>
        </div>
