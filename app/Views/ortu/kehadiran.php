...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .date-text { font-size: 0.7rem; color: var(--gray); display: flex; align-items: center; gap: 5px; }
        ...
        .ket-text { font-size: 0.85rem; color: var(--gray); max-width: 250px; }
        ...
        <div class="dashboard-content" id="mainContent">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="3" style="text-align:center;padding:60px;color:var(--gray);">
                                        ...
                                        <h3 style="margin-bottom: 8px; color: var(--dark); font-weight: 600;">Belum Ada Data Kehadiran</h3>
                                        <p style="max-width: 300px; margin: 0 auto;">Belum ada catatan kehadiran yang tersedia untuk putra-putri Anda.</p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
            ...
            <div class="section-card">
                ...
                <div style="padding: 20px 24px;">
                    <p style="margin-bottom: 12px;">Berikut adalah keterangan tentang status kehadiran santri:</p>
                    <ul style="margin-left: 20px; margin-bottom: 15px;">
                        <li>• <strong class="badge-hadir" style="background:transparent; padding:0;">Hadir</strong> - Santri hadir mengikuti kegiatan pembelajaran</li>
                        <li>• <strong class="badge-izin" style="background:transparent; padding:0;">Izin</strong> - Santri tidak hadir dengan keterangan izin dari orang tua</li>
                        <li>• <strong class="badge-sakit" style="background:transparent; padding:0;">Sakit</strong> - Santri tidak hadir karena sakit (dapat disertai surat keterangan)</li>
                        <li>• <strong class="badge-alpa" style="background:transparent; padding:0;">Alpa</strong> - Santri tidak hadir tanpa keterangan yang jelas</li>
                    </ul>
                    <p style="margin-top: 15px; padding-top: 12px; border-top: 1px solid var(--light-gray); font-size: 0.85rem; color: var(--gray);">Catatan: Data kehadiran diperbarui setiap hari oleh ustadz/pengajar. Untuk informasi lebih lanjut, silakan hubungi wali kelas.</p>
                </div>
            </div>
        </div>
    </div>
