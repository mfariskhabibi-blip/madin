...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .invoice-type { font-size: 0.75rem; color: var(--gray); margin-top: 4px; }
        ...
        .modal-card { background: #fff; width: 100%; max-width: 450px; border-radius: var(--radius); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2); animation: slideUp 0.3s ease; overflow: hidden; }
        @keyframes slideUp { from { opacity:0; transform: translateY(20px); } to { opacity:1; transform: translateY(0); } }
        .modal-header { display: flex; justify-content: space-between; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--light-gray); background: var(--light); }
        .modal-header h3 { font-size: 1rem; font-weight: 700; color: var(--primary-dark); display: flex; align-items: center; gap: 8px; }
        ...
        .modal-footer { padding: 12px 20px; background: var(--light); border-top: 1px solid var(--light-gray); display: flex; justify-content: flex-end; gap: 10px; }
        ...
        .file-input { width: 100%; padding: 12px 14px; border: 2px dashed var(--light-gray); border-radius: 6px; font-size: 0.85rem; outline: none; background: #fff; cursor: pointer; }
        ...
        .info-box ul { margin-left: 20px; margin-top: 5px; font-size: 0.75rem; }
        ...
        @media (max-width: 768px) {
            ...
            .table td div, .table td span, .table td button { text-align: left; flex: 1; }
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-content" id="mainContent">
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Bukti / Aksi">
                                            <?php if($r['status'] == 'Lunas'): ?>
                                                <span style="color: var(--success); font-size: 0.7rem; font-weight: 600;"><i class="fas fa-check-circle"></i> Terverifikasi</span>
                                            <?php elseif($r['bukti_bayar']): ?>
                                                <span style="color: var(--info); font-size: 0.7rem; font-weight: 600;"><i class="fas fa-hourglass-half"></i> Menunggu Verifikasi</span>
                                            <?php else: ?>
                                ...
                                <tr>
                                    <td colspan="4" style="text-align:center; padding: 50px 20px;">
                                        <div class="empty-state" style="box-shadow: none; margin: 0; padding: 20px;">
                                            ...
                                            <p>Tidak ada data tagihan yang ditemukan untuk putra-putri Anda.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
            ...
            <div class="section-card">
                ...
                <div class="info-list">
                    <p><strong><i class="fas fa-university"></i> Nomor Rekening Pembayaran:</strong></p>
                    <ul>
    ...
    <script>
        ...
        const modalTitle = document.querySelector('#uploadModal .modal-header h3');
