...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .badge-lancar { background: rgba(38, 162, 105, 0.1); color: var(--success); }
        ...
        .act-edit:hover { background: #0284c7; transform: scale(1.05); }
        .act-delete { background: var(--danger); }
        .act-delete:hover { background: #c53030; transform: scale(1.05); }
        ...
        .info-box { background: var(--light); padding: 12px; border-radius: 8px; margin-bottom: 16px; }
        .info-box .label { font-size: 0.7rem; color: var(--gray); margin-bottom: 4px; }
        .info-box .value { font-weight: 700; color: var(--primary-dark); font-size: 0.9rem; }
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-item active"><a href="<?= base_url('ustadz/hafalan') ?>"><i class="fas fa-quran"></i><span>Setoran Hafalan</span></a></div>
        ...
        <div class="dashboard-content" id="mainContent">
            ...
            <div class="filter-card">
                <form action="<?= base_url('ustadz/hafalan') ?>" method="get" class="filter-form">
                    ...
                    <div class="filter-group" style="display: flex; gap: 8px; align-items: center;">
                        ...
                        <?php if(!empty($filter['santri']) || !empty($filter['id_kelas']) || !empty($filter['tanggal'])): ?>
                            <a href="<?= base_url('ustadz/hafalan') ?>" class="btn btn-outline" style="height: 42px;">
        ...
        <form id="editForm" method="post" class="modal-card">
            ...
            <div class="modal-body">
                <div class="info-box">
                    ...
                    <div class="value" id="edit_nama_santri"></div>
                </div>
                <div class="form-group">
                    <label class="form-label">Tanggal</label>
